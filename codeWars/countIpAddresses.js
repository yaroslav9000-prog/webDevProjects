...
exports.ipsBetween = void 0;
function ipsBetween(start, end) {
    //TODO
    var firstIp = start.split(".").map(function (item) { return parseInt(item); });
    var secondIp = end.split(".").map(function (item) { return parseInt(item); });
    var diffFirst = [];
    var diffSecond = [];
    var arrayOfUnits = [Math.pow(256, 3), Math.pow(256, 2), Math.pow(256, 1), 1];
